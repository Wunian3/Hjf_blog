...
type SessionSetting struct {
	ChatScope    int `yaml:"chat-scope" json:"chat_scope"`       //对话积分消耗
	SessionScope int `yaml:"session-scope" json:"session_scope"` //会话消耗
	DayScope     int `yaml:"day-scope" json:"day_scope"`
}

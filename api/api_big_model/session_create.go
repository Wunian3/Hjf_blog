...
func (ApiBigModel) SessionCreateView(c *gin.Context) {
	...
	if user.Scope-scope <= 0 {
		res.FailWithMessage("积分不足，无法创建会话", c)
		return
	}
